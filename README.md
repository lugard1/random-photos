...
## Learning Objectives
- Understand how to replicate a cool Random Photos application which features a load more button that adds more photos on every click with a cool UI.
- Flexbox to place elements in the page.

## Description of the Project
For the first milestone in the process of creating Random Photos, you will:
